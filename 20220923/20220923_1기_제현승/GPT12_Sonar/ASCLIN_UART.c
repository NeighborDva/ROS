...
void send_sonar_data(int sonar_data)
{
    ...
    send_buff[0] = '#';
    send_buff[1] = 'I';
    send_buff[2] =  m_sonar_value.bytedata[0];
    send_buff[3] =  m_sonar_value.bytedata[1];
    send_buff[4] =  m_sonar_value.bytedata[2];
    send_buff[5] =  m_sonar_value.bytedata[3];
